...
export default function AuthForm({ type }: AuthFormProps) {
  ...
  return (
    ...
    <div className="d-flex align-items-center justify-content-center p-4 bg-dotstark-light">
      <div className="bg-white rounded-3xl dotstark-shadow-lg max-w-md w-full p-4 mx-4 slide-up">
