    ...
    <div className="max-w-4xl mx-auto mt-8 p-4">
      ...
      <div className="mb-4">
        <p className="text-sm font-medium text-gray-700">
          ...
          <span className="ml-2 font-bold text-coust00">
        ...
        <div className="border-top pt-4">
          <div className="d-flex gap-2">
            <textarea
              ...
              className="form-control flex-grow-1 p-2 border rounded resize-none focus-border-indigo"
              rows={3}
              disabled={isLoading || !tenant}
            />
            <button
              onClick={handleSendMessage}
              className="btn custom-indigo px-4 py-2 rounded"
