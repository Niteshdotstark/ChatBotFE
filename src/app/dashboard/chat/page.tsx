...
export default function ChatPage() {
    ...
    return (
        ...
        <div className="p-4 flex flex-col h-full">
            ...
            <div className="bg-white rounded-3xl dotstark-shadow p-4 flex flex-col flex-1 min-h-0">
                {/* Messages Area */}
                    ...
                    <div className="relative w-100">
                        <textarea
                            ...
                            placeholder={
                                activeTenant
                                    ? 'Type your message...'
                                    : 'Select an organization to chat'
                            }
                            className="form-control w-100 pl-4 pr-20 py-3 fs-6 fw-medium rounded-4 custom-focus-orange"
                            rows={1}
                        ...
                        <div className="absolute right-2 top-1 bottom-1 flex items-center">
                             <button
                                ...
                                className="dotstark-gradient text-white h-8 w-8 rounded-full flex items-center justify-center shadow-sm hover:shadow-md transition-transform hover:scale-105"
                                disabled={
                                    isChatLoading ||
