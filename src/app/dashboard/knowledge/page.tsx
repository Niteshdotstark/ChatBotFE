...
export default function KnowledgePage() {
    ...
    return (
        <div className="p-4">
            ...
            <div className="bg-white card-hover dotstark-shadow p-4 mb-4 rounded-3">
                <h3 className="fw-bold text-dark mb-4 text-uppercase custom-tracking nunito-font">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <input
                            ...
                            className="form-control w-100 px-4 py-3 fs-6 fw-medium rounded-4 custom-focus-orange"
                            ...
                            <div className="animate-slide-up">
                                ...
                                <div className="custom-scrollbar pr-2 mb-3" style={{ maxHeight: '200px', overflowY: 'auto' }}>
                                    {selectedFiles.map((file, index) => (
                                        <div
                                            key={index}
                                            className="bg-gray-50 rounded-4 p-3 mb-2 border border-gray-200 d-flex justify-content-between align-items-center"
                                        >
                                            <div className="d-flex align-items-center gap-3 overflow-hidden">
                                                <div className="w-8 h-8 bg-orange-100 rounded-lg d-flex align-items-center justify-content-center flex-shrink-0">
            ...
            <h3 className="text-xl font-nunito font-bold text-gray-900 mb-6 uppercase tracking-wide px-4">
            ...
            <div className="custom-scrollbar" style={{ maxHeight: '600px', overflowY: 'auto' }}>
                {isLoading && knowledgeBaseItems.length === 0 && activeTenant ? (
                    ...
                    <div className="text-center py-5 bg-white card-hover dotstark-shadow rounded-3xl mx-4">
                    ...
                    <div className="space-y-4 px-4 pb-4">
                        {knowledgeBaseItems.map((item) => (
                            <div
                                key={item.id}
                                className="bg-white card-hover dotstark-shadow p-5  my-2 flex items-center justify-between rounded-3xl"
                            >
                                <div className="d-flex align-items-center gap-4 overflow-hidden">
                                    <div className="w-14 h-14 bg-gray-100 rounded-2xl d-flex align-items-center justify-content-center flex-shrink-0">
                                        {getSourceIcon(item)}
                                    </div>
                                    <div className="overflow-hidden">
                                        <p className="font-nunito font-bold text-gray-900 text-lg text-truncate mb-1">
                                ...
                                <div className="d-flex align-items-center gap-3 flex-shrink-0">
                                    <span className="bg-green-100 text-green-800 text-xs font-nunito font-bold px-3 py-2 rounded-full uppercase tracking-wide d-none d-md-inline-block">
                                        SYNCED
                                    </span>
                                    <button
